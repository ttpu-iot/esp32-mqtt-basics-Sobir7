...
const char* client_id = "sobir_lab3";

// Topics
const char* topic_button  = "ttpu/iot/sobir/events/button";
const char* topic_red     = "ttpu/iot/sobir/led/red";
const char* topic_green   = "ttpu/iot/sobir/led/green";
const char* topic_blue    = "ttpu/iot/sobir/led/blue";
const char* topic_yellow  = "ttpu/iot/sobir/led/yellow";
const char* topic_display = "ttpu/iot/sobir/display";
